...
/**
 * A physical media as part of an episode. In most cases, this is the full length media of the episode. Chapters are used for physical segmentation, as opposed to Segments which are used for logical segmentation.
 *
 * @param date 
 * @param id 
 * @param imageUrl 
 ...
 * @param urn 
 * @param vendor 
 * @param fullLengthMarkIn The markIn (starting point) in milliseconds of the corresponding full length media. Only set for video with onlyChapters=true. For full length videos and audios, this value is set to null.
 * @param fullLengthMarkOut The markOut in milliseconds of the corresponding full length media. See also fullLengthMarkIn
 * @param resourceList List of all resources ordered by their \"general playability\". The client is free to choose theresource most suitable for its device and use case. The new SAM sorting algorithm puts HLS/https/HD in first position, more details in code (see ResourceComparator.kt).
 * @param segmentList 
 * @param timeIntervalList The optional time interval list of this chapter.
 * @param aspectRatio 
 * @param dvrReferenceDate 
 * @param spriteSheet 
...
data class ChapterDto (
    ...
    /* The markIn (starting point) in milliseconds of the corresponding full length media. Only set for video with onlyChapters=true. For full length videos and audios, this value is set to null. */
    @field:JsonProperty("fullLengthMarkIn")
    val fullLengthMarkIn: kotlin.Long? = null,

    /* The markOut in milliseconds of the corresponding full length media. See also fullLengthMarkIn */
    @field:JsonProperty("fullLengthMarkOut")
    val fullLengthMarkOut: kotlin.Long? = null,

    /* List of all resources ordered by their \"general playability\". The client is free to choose theresource most suitable for its device and use case. The new SAM sorting algorithm puts HLS/https/HD in first position, more details in code (see ResourceComparator.kt). */
    @field:JsonProperty("resourceList")
    val resourceList: kotlin.collections.List<ResourceDto>? = null,

    @field:JsonProperty("segmentList")
    val segmentList: kotlin.collections.List<SegmentDto>? = null,

    /* The optional time interval list of this chapter. */
    @field:JsonProperty("timeIntervalList")
    val timeIntervalList: kotlin.collections.List<TimeIntervalDto>? = null,

    @field:JsonProperty("aspectRatio")
    val aspectRatio: AspectRatioDto? = null,

    @field:JsonProperty("dvrReferenceDate")
    val dvrReferenceDate: java.time.LocalDateTime? = null,

    @field:JsonProperty("spriteSheet")
