...
class MediaScheduledLivestreamDtoTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of MediaScheduledLivestreamDto
        //val modelInstance = MediaScheduledLivestreamDto()
        ...
        // to test the property `creatorUser`
        should("test creatorUser") {
            // uncomment below to test the property
            //modelInstance.creatorUser shouldBe ("TODO")
        }
