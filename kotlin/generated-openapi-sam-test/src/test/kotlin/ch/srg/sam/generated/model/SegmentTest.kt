...
class SegmentDtoTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of SegmentDto
        //val modelInstance = SegmentDto()
        ...
        // to test the property `markIn` - Starting point in milliseconds
        should("test markIn") {
            // uncomment below to test the property
            //modelInstance.markIn shouldBe ("TODO")
        }

        // to test the property `markOut` - End point in milliseconds
        should("test markOut") {
            // uncomment below to test the property
